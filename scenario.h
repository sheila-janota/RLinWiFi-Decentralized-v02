...
class Scenario
{
  protected:
    ...
    void installTrafficGenerator(ns3::Ptr<ns3::Node> fromNode,
                                 ...
                                 double startTime,
                                 double endTime,
                                 ns3::Callback<void, Ptr<const Packet>, Ptr<Ipv4>, uint32_t> callback);
  ...
  public:
    ...
    virtual void installScenario(double simulationTime, double envStepTime, ns3::Callback<void, Ptr<const Packet>, Ptr<Ipv4>, uint32_t> callback) = 0;
...
class BasicScenario : public Scenario
{
  ...
  public:
    void installScenario(double simulationTime, double envStepTime, ns3::Callback<void, Ptr<const Packet>, Ptr<Ipv4>, uint32_t> callback) override;
};
...
void BasicScenario::installScenario(double simulationTime, double envStepTime, ns3::Callback<void, Ptr<const Packet>, Ptr<Ipv4>, uint32_t> callback)
{
...
void ConvergenceScenario::installScenario(double simulationTime, double envStepTime, ns3::Callback<void, Ptr<const Packet>, Ptr<Ipv4>, uint32_t> callback)
{
